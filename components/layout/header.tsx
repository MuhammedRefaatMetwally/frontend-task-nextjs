            ...
            <div className="max-w-7xl mx-auto px-6 py-4">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-4">
                        <Link href="/#" className="text-gray-600 hover:text-gray-900 relative w-6 h-6" onClick={(e) => e.preventDefault()}>
                            <Image
                        ...
                        <Link href="/#" className="text-gray-600 hover:text-gray-900 relative w-10 h-8" onClick={(e) => e.preventDefault()}>
                            <Image
